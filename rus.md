...
шаблоны друг в друга так глубоко, как хочется:
...
Обратите внимание, деструктурирующее присваивание с шаблоном массива работает
также и с любым итерируемым объектом:
...
может быть связана одна ошибка, и вам об этом следует знать:
